...
const ALLOWED_COMPANIES: Record<string, CompanyConfig> = {
  "407etr": { slug: "407etr", displayName: "407 ETR", brandColor: "#F7B500", brandAccent: "#001140" },
...
const ALLOWED_COMPANY_ROLES: Record<string, Record<string, CompanyConfig>> = {
  ...
  cibc: {
    ...
    "software-developer": {
      slug: "cibc/software-developer",
      displayName: "CIBC",
      subtitle: "Software/Application Developer Co-op",
      brandColor: "#9D2235",
      brandAccent: "#FFD500",
    },
    "capital-markets-developer": {
      slug: "cibc/capital-markets-developer",
      displayName: "CIBC",
      subtitle: "Application Developer Co-op, Capital Markets Technology",
      brandColor: "#9D2235",
      brandAccent: "#FFD500",
    },
  },
